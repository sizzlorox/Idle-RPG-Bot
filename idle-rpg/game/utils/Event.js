        ...
        switch (luckItem) {
          case 0:
            ...
            if (victimPlayer.equipment.helmet.name !== enumHelper.equipment.empty.helmet.name) {
              if (Helper.calculateItemRating(stealingPlayer, stealingPlayer.equipment.helmet.power) < Helper.calculateItemRating(victimPlayer, victimPlayer.equipment.helmet.power)) {
          ...
          case 1:
            ...
            if (victimPlayer.equipment.armor.name !== enumHelper.equipment.empty.armor.name) {
              if (Helper.calculateItemRating(stealingPlayer, stealingPlayer.equipment.armor.power) < helepr.calculateItemRating(victimPlayer, victimPlayer.equipment.armor.power)) {
          ...
          case 2:
            ...
            if (victimPlayer.equipment.weapon.name !== enumHelper.equipment.empty.weapon.name) {
              if (Helper.calculateItemRating(stealingPlayer, stealingPlayer.equipment.weapon.power) < Helper.calculateItemRating(victimPlayer, victimPlayer.equipment.weapon.power)) {
