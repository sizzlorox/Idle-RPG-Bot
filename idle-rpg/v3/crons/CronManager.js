  ...
  loadCrons() {
    new CronJob({
      ...
      onTick: () => {
        ...
        powerHourBegin(this.bot, this.game);
      },
      start: false,
    ...
    new CronJob({
      ...
      onTick: () => {
        ...
        dailyLottery(this.bot, this.game);
      },
      start: false,
      timeZone: this.timeZone,
      runOnInit: false,
    ...
    new CronJob({
      ...
      onTick: () => {
        ...
        blizzardRandom(this.bot, this.game);
      },
      start: false,
      timeZone: this.timeZone,
      runOnInit: false,
    ...
    new CronJob({
      ...
      onTick: () => {
        cronLog.info('CronJob invasionRandomTime ran');
        invasionRandom(this.bot, this.game);
      },
      start: false,
      timeZone: this.timeZone,
      runOnInit: false,
    ...
    new CronJob({
      ...
      onTick: () => {
        cronLog.info('CronJob bloodMoonRandomTime ran');
        bloodMoonRandom(this.bot, this.game);
      },
      start: false,
      timeZone: this.timeZone,
      runOnInit: false,
    ...
    new CronJob({
      cronTime: '00 00 */4 * * *',
      onTick: () => {
        cronLog.info('CronJob weatherEventRandomTime ran');
        weatherEventRandom(this.bot, this.game);
      },
      start: false,
      timeZone: this.timeZone,
      runOnInit: false,
    ...
    new CronJob({
      cronTime: '00 00 0 * * *',
      onTick: () => {
        cronLog.info('CronJob checkHolidays ran');
        checkHolidays(this.bot, this.game);
      },
      start: false,
      timeZone: this.timeZone,
      runOnInit: false,
    ...
    new CronJob({
      ...
      onTick: () => {
        ...
        updateLeaderboards(this.bot, this.game);
      },
      start: false,
      timeZone: this.timeZone,
      runOnInit: true,
